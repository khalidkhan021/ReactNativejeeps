...
this.state={
    ...
    render(){
      ...
      const description = params.description ? params.description : 'Description not fill yet';

      console.log('parmsa===========',params.id)
        return(
        ...
        <Card style={{alignSelf:"center",borderRadius:13,width:"90%",justifyContent:"center",marginTop:"1.5%",backgroundColor:"#58595B",padding:10}}>
              ...
              <Text style={{fontWeight: "bold",fontSize:25,color:"#fff",textDecorationLine:'underline'}}>Search </Text>
              <Text style={{fontWeight: "bold",fontSize:25,color:"#678a01",textDecorationLine:'underline'}}>Product</Text>
              </View>
            ...
            <View style={{flexDirection:"row", display: 'flex', justifyContent: 'flex-start'}}>
              {/* <TouchableOpacity >     */}
                <Button onPress={()=>{this.props.navigation.navigate('select')}} iconLeft transparent large>
          ...
          <View style={{marginTop:'10%'}}>
                ...
                <View style={{marginTop:'2%',borderWidth:3,borderColor:'gray',borderRadius:10}}>
                 <Image source={{uri: 'data:image/jpeg;base64,'}} style={{height:150, width:"100%", flex: 1}}/>
                  ...
                  <Text style={styles.text1}>Price: {params.price}euro</Text>
